 ...
 * stream */
typedef seqParamSet_t SPS_t;

/* data structure to store PPS information decoded from the stream */
typedef picParamSet_t PPS_t;

/*------------------------------------------------------------------------------
    Prototypes of Decoder API functions
------------------------------------------------------------------------------*/

    const void *H264ToDWLinstance(H264DecInst pDecInst);
    u32 h264bsdStoreSeqParamSetExt(H264DecInst pDecInst, SPS_t * pSeqParamSet);
    u32 h264bsdStorePicParamSetExt(H264DecInst pDecInst, PPS_t * pPicParamSet);
